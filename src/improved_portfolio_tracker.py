...
class PortfolioTracker:
    ...
    def add_transaction(self, coin_id: str, coin_name: str, 
    ...
    def calculate_holdings(self) -> Dict[str, Dict]:
        ...
        for transaction in self.transactions:
            ...
            if txn_type == 'buy':
                ...
                holdings[coin_id]['total_amount'] = max(0, holdings[coin_id]['total_amount'] - amount)
    ...
    def get_portfolio_summary(self, current_prices: Dict = None) -> Dict:
        ...
        for coin_id, holding in self.holdings.items():
            ...
            symbol = holding['name'].split()[0].upper() if holding['name'] else coin_id.upper()
